...
d1 = density(D$lam.est[D$n==100 & D$lam.true==2 & D$phi.true==.75])
d2 = density(D$lam.est[D$n==200 & D$lam.true==2 & D$phi.true==.75])
d4 = density(D$lam.est[D$n==400 & D$lam.true==2 & D$phi.true==.75])
d1s = density(D$lam.est[D$n==100 & D$lam.true==2 & D$phi.true==.25])
d2s = density(D$lam.est[D$n==200 & D$lam.true==2 & D$phi.true==.25])
d4s = density(D$lam.est[D$n==400 & D$lam.true==2 & D$phi.true==.25])
...
d1 = density(D$phi.est[D$n==100 & D$lam.true==10 & D$phi.true==.75])
d2 = density(D$phi.est[D$n==200 & D$lam.true==10 & D$phi.true==.75])
d4 = density(D$phi.est[D$n==400 & D$lam.true==10 & D$phi.true==.75])
d1s = density(D$phi.est[D$n==100 & D$lam.true==2 & D$phi.true==.75])
d2s = density(D$phi.est[D$n==200 & D$lam.true==2 & D$phi.true==.75])
d4s = density(D$phi.est[D$n==400 & D$lam.true==2 & D$phi.true==.75])
